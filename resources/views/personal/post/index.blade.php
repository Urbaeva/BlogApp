                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('personal.post.index') }}">Posts</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1  mb-3">
                        <a href="{{ route('personal.post.create') }}" class="btn btn-block btn-primary">Add post</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    @foreach($posts as $post)
                                        ...
                                        <tr>
                                            <td>{{ $post->id }}</td>
                                            <td>{{ $post->title }}</td>
                                            <td><a href="{{ route('personal.post.show', $post->id) }}">
